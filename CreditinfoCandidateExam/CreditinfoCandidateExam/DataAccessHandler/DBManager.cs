...
namespace CreditinfoCandidateExam.DataAccessHandler
{
    public class DBManager
    {
        ...
        {
            return DataParameterManager.CreateSqlParameter(name, value, dbType, ParameterDirection.Input);
        }

        public IDbDataParameter CreateParameter(string name, int size, object value, DbType dbType)
        {
            return DataParameterManager.CreateSqlParameter(name, size, value, dbType, ParameterDirection.Input);
        }

        public IDbDataParameter CreateParameter(string name, int size, object value, DbType dbType, ParameterDirection direction)
        {
            return DataParameterManager.CreateSqlParameter(name, size, value, dbType, direction);
        }
